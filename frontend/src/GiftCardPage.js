      ...
      >
        <CardContent>
          ...
          <img
            ...
            src={
              "https://www.tatacliq.com/src/account/components/img/gift_card.png"
            }
            alt={"Gift Card"}
          />
          <Stack direction="row" spacing={2} sx={{ mb: 2 , mt: 4 }}>
            ...
            <Button
              variant={
                giftCardData.amount === "1000" ? "contained" : "outlined"
              }
            ...
            <Button
              variant={
                giftCardData.amount === "2000" ? "contained" : "outlined"
              }
          ...
          <TextField
            ...
            onChange={(e) =>
              setGiftCardData({ ...giftCardData, email: e.target.value })
            }
          />

          <Typography variant="body2" sx={{ mb: 3 }}>
            {giftCardData.senderName} (from){" "}
